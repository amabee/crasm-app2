                ...
                <table class="data-table table nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Gorra</td>
                            <td></td>
                            <td>shangorra@rocketmail.com</td>
                            <td>Super Admin</td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editUserForm">
                    ...
                    <div class="mb-3">
                        <label for="editSuffix" class="form-label">Email</label>
                        <input type="text" class="form-control" id="editSuffix" name="suffix">
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="userForm">
                        ...
                        <div class="mb-3">
                        <label for="editSuffix" class="form-label">Role</label>
                        <input type="text" class="form-control" id="editSuffix" name="suffix">
                    </div>
                    </form>
                </div>
