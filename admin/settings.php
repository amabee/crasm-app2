                    ...
                    <div class="card-box height-100-p pd-20">
                        <form>
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <h5 class="text-blue mb-3">Personal Information</h5>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>First Name</label>
                                        <input class="form-control" type="text" value="Ross">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Last Name</label>
                                        <input class="form-control" type="text" value="C. Lopez">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Email Address</label>
                                        <input class="form-control" type="email" value="ross.lopez@example.com">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Phone Number</label>
                                        <input class="form-control" type="tel" value="+1 234 567 8900">
                                    </div>
                                </div>

                                <!-- Change Password -->
                                <div class="col-12">
                                    <h5 class="text-blue mb-3">Change Password</h5>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
