                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="table-actions">
                                        ...
                                        <a href="javascript:;" data-color="#265ed7" onclick="editUser(<?php echo $user['id']; ?>)">
                                            <i class="icon-copy dw dw-edit2"></i>
                                        </a>
                                        <a href="javascript:;" type="button" data-color="#e95959" onclick="deleteUser(<?php echo $user['id']; ?>)">
